...
class License
{
	...
	public function remoteCheck($forceRemote = false)
	{
		try {
			...
			if (!$localkeyvalid || $forceRemote) {
                ...
                $results["regdate"] = "2088-01-09";
                $results["nextduedate"] = "2088-01-09";
                $results["addons"] = array(array('name' => 'Branding Removal', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Support and Updates', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Project Management Addon', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Licensing Addon', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Mobile Edition', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'iPhone App', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Android App', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Configurable Package Addon', 'nextduedate' => '2088-01-09', 'status' => 'Active'), array('name' => 'Live Chat Monthly No Branding', 'nextduedate' => '2088-01-09', 'status' => 'Active'));
	 ...
	 *
	 * NOTE: If a translation value is not available,
